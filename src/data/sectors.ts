...
export const sectors: Sector[] = [
	{
		...
		changes: 'The Warning Light gives you that signal — per component, every step, while the run is still recoverable.',
	...
	},
	{
		...
		changes: "Attribution per component means validation per component. The record answers SR 26-2's validation and change-control expectations with evidence rather than with a memo.",
