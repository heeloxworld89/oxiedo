...
export const sectors: Sector[] = [
	{
		...
		cost: 'Mid-training collapse on a large run is the most expensive invisible problem in ML infrastructure. No per-component signal exists in the current stack to detect it before it completes.',
	...
	},
	{
		...
		buyerQuote: 'The compliance sector has named the solution category — "unlearning-ready architectures" — before any supply exists.',
