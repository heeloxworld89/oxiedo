...
Other combinations are possible and some of them are obvious. This page lists what we will sign a contract against, which is why they are not on it. Adding one costs a configuration change rather than a second licence.
