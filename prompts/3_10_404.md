...
- Build `404.astro` using the copy already written in `design/10 §404`.
- Three CTAs: Home · Paper · Contact.

## Do not

- Do not write new 404 copy — it exists.
- Do not add a search box or a sitemap listing.

## Exit condition

404 renders with three working links. Copy verbatim from `design/10`.

**Then commit.** One commit, message `3.10 404`. Nothing else in it.
